...
class LifecycleTest < ActiveSupport::TestCase
  ...
  def test_auto_observer
    ...
    assert_nil TopicaAuditor.default_observed_class
  ...
  def test_inferred_auto_observer
    ...
    assert_equal [Topic], TopicObserver.observed_classes.to_a
  ...
  def test_after_find_can_be_observed_when_its_not_defined_on_the_model
    ...
    assert_equal [ Minimalistic ], MinimalisticObserver.observed_classes.to_a
